...
#TODO - add check 3-rd parameter for set default ansver (if press enter)
 ...
 case "$x" in
 y |Y |yes |ä |Ä |ÄÁ ) return 0;;
 n |N |no |î |Î |ÎÅÔ ) return 1;;
# * ) ; # asc again
 esac
    done
}
...
<virtualhost *:80>
 ServerName ${USER_NAME}.${HOST_NAME}
		...
		# open_basedirÄÌÑ ÄÏÍÁÛÎÅÊ ÄÉÒÅËÔÏÒÉÉ ÐÏÌØÚÏ×ÁÔÅÌÑ, ÍÏÖÎÏ ÄÏÂÁ×ÉÔØ ÎÅÓËÏÌØËÏ ÄÉÒÅËÔÏÒÉÊ ÐÒÉ ÎÅÏÂÈÏÄÉÍÏÓÔÉ, ÄÉÒÅËÔÏÒÉÉ ÒÁÚÄÅÌÑÀÔÓÑ Ä×ÏÅÔÏÞÉÅÍ .:.
		php_admin_value open_basedir "/web/${USER_NAME}/"
		# ÷ËÌÀÞÁÅÍ ÓÅÊÆ-ÍÏÄ, Ñ ÓÄÅÌÁÌ ÜÔÏ × ËÁÖÄÏÍ ËÏÎÆÉÇÅ ÓÁÊÔÁ ÄÌÑ ÕÄÏÂÓÔ×Á ÏÔËÌÀÞÅÎÉÑ ÐÒÉ ÎÅÏÂÈÏÄÉÍÏÓÔÉ.
		php_admin_value safe_mode "on"
		# ïÐÒÅÄÅÌÑÅÍ ÎÁÛÕ ×ÒÅÍÅÎÎÕÀ ÄÉÒÅËÔÏÒÉÀ ËÁË ÏÓÎÏ×ÎÕÀ, ×ÍÅÓÔÏ /tmp É ÕÓÔÁÎÁ×ÌÉ×ÁÅÍ Å£ ÄÉÒÅËÔÏÒÉÅÊ ÄÌÑ ÈÒÁÎÅÎÉÑ ÓÅÓÓÉÊ.
